...
<body>
    ...
    <div class="fb-home-header">
        ...
        <div class="fb-home-menu">
            <ul>
                <li class="active">
                    <a href="#"><svg viewBox="0 0 28 28" class="x1lliihq x1k90msu x2h7rmj x1qfuztq x5e5rjt" fill="currentColor" height="28" width="28">
                ...
                <li>
                    <a href="#"><svg viewBox="0 0 28 28" class="x1lliihq x1k90msu x2h7rmj x1qfuztq xcza8v6" fill="currentColor" height="28" width="28">
        ...
        <div class="fb-home-user">
            ...
            <div class="fb-user-item">
                <a href="#"><svg fill="currentColor" viewBox="0 0 44 44" width="1em" height="1em" class="x1lliihq x1k90msu x2h7rmj x1qfuztq x198g3q0 x1qx5ct2 xw4jnvo">
            ...
            <div class="fb-user-item">
                <a href="#"><svg viewBox="0 0 28 28" alt="" class="x1lliihq x1k90msu x2h7rmj x1qfuztq x198g3q0" fill="currentColor" height="20" width="20">
    ...
    <div class="fb-home-body">
        ...
        <div class="fb-home-timeline-area">
            <div class="fb-home-timeline">
                ...
                <div class="story-box">
                    ...
                    <div class="story-box-body">
                        <div class="story-area">
                            <div class="story-item auth-user-story" style="background-image: url('https://placehold.co/40x40?text=Photo')">
                        ...
                        <div class="modal-content">
                            ...
                            <form action="{{ route('post.store') }}" method="POST">
                                ...
                                <div class="modal-body">
                                    ...
                                    <textarea name="post_content" class="form-control border-0 shadow-none p-0 mt-3" id="" placeholder="What's on your mind, Gouranga?" rows="5"></textarea>
                                </div>
                ...
                <!-- User Post  -->
                @foreach($posts -> sortByDesc('id') as $item)
                <div class="user-post">
                    ...
                    <div class="post-comments">
                        ...
                        <div class="comments-menu">
                            <ul>
                                ...
                                <li data-bs-toggle="modal" data-bs-target="#commentModal{{ $item -> id}}">
                                    <span class="comment-icon"></span>
                                    <span>Comment</span>
                                </li>
                    ...
                    <!-- Comment Modal -->
                    <div class="modal fade" id="commentModal{{ $item -> id}}" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                                                ...
                                                <div class="d-flex align-items-center justify-content-between gap-2 w-100">
                                                    ...
                                                    <div>
                                                        <select name="profile_id" id="" class="form-select select-profile">
                                                            ...
                                                            <option value="{{ $profile -> id }}"> {{ $profile -> getFullNameAttribute() }} </option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                                                </div>
